...
export function ProcessFinalCTA() {
  ...
  const t = useTranslations('process.finalCta')
  ...
  return (
    <section className="relative bg-navy px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-32 md:py-48">
      <div className="max-w-[1800px] mx-auto">
        ...
        >
          {(t.raw('steps') as Array<{ num: string; title: string; desc: string }>).map((step, i) => (
            <motion.div
              key={i}
        ...
        >
          <p className="text-white/40 text-sm mb-6">{t('contactNote')}</p>
