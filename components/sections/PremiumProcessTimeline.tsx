...
export function PremiumProcessTimeline() {
  ...
  return (
    <section ref={containerRef} className="relative bg-navy py-32 md:py-48 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-gold/10 rounded-full blur-[120px]"
        />
        <motion.div
          animate={shouldReduceMotion ? {} : {
            scale: [1.2, 1, 1.2],
          ...
          className="absolute -bottom-40 -right-40 w-[700px] h-[700px] bg-gold/5 rounded-full blur-[150px]"
        />
        {/* Grid pattern */}
        <div
      ...
      <div className="relative max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="absolute left-8 md:left-1/2 top-0 bottom-0 md:-translate-x-1/2 hidden md:block">
          ...
          <div className="absolute inset-0 w-0.5 bg-white/10" />
        ...
        {/* Mobile line - static */}
        <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-gold via-gold/50 to-white/20 md:hidden" />
                ...
                <div className={`hidden md:grid md:grid-cols-2 gap-8 md:gap-16 items-center`}>
                  ...
                  <div className={isEven ? 'md:order-2 md:pl-16' : 'md:pr-16'}>
                    ...
                    >
                      ...
                      <span className="font-serif text-[120px] lg:text-[160px] font-bold text-white/[0.05] select-none">
                        {step.number}
                      </span>
                    </motion.div>
                  </div>
      ...
      >
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-gold via-gold-light to-gold text-navy rounded-full font-bold text-lg shadow-xl shadow-gold/20 hover:shadow-2xl hover:shadow-gold/30 transition-all duration-300"
        >
...
function StepCard({
  ...
  return (
    <div className={`relative ${alignRight ? 'text-right' : ''}`}>
      {/* Content card */}
      <div className="relative bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-black/5">
        {/* Icon */}
        <motion.div
          ...
          style={{
            backgroundColor: step.color === 'gold' ? '#B89245' : '#0E1D3D'
          }}
        ...
        <div className={alignRight ? 'clear-right' : ''}>
          {/* Number badge */}
          <span
            className="inline-block text-sm font-bold uppercase tracking-wider mb-2"
            style={{
              color: step.color === 'gold' ? '#B89245' : '#0E1D3D'
            }}
          >
            Trin {step.number}
          </span>
